...
class ResnetDilated(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=8):
        ...
        self.head1 = DeepLabHead(input_channels=2048,output_channels=7,img_size=[256,512])
        self.head2 = DeepLabHead(input_channels=2048,output_channels=1,img_size=[256,512])
    ...
    def forward(self, x):
        ...
        result = [self.head1(x),self.head2(x)]
        return result
